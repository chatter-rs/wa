...
async function findAppModules() {
    ...
    waVersionParsed = waVersion.split(".");
	await fs.writeFile("../src/version.rs", `pub const PROTO_VERSION: [u16; 3] = [${waVersionParsed[0]}, ${waVersionParsed[1]}, ${waVersionParsed[2]}];`)
...
(async() => {
	...
	const destinationPath = '../src/whatsapp.proto'
